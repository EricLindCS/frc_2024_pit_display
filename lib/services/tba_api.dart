...
class TBA {
  static const _apiKey =
      'nqfMis7Ls4PP1aGAq5kKrgrX1DhE7xv2pLlUUhz5BKtSsyeSrnolRuGkQTxrfQb6';
  ...
  static Future<List<Match>?> getTeamMatchSchedule() async {
    ...
    int team = _prefs?.getInt('teamNumber') ?? 2584;
    String event = _prefs?.getString('eventKey') ?? '2024cala';
    ...
    for (Map<String, dynamic> matchJson in responseJson) {
      ...
      if (key != null) {
        ...
        statpred =
            ((s_responseLst['pred']['red_win_prob'] as num) * 100).toInt();
      }
